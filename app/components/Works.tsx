    ...
    return (
        <div className={"flex flex-col items-center gap-8"}>
            ...
            <div className={"flex max-lg:flex-col gap-6"}>
                ...
                <div className={"bg-backgroundMuted max-lg:rounded lg:rounded-r-3xl lg:w-[606px] lg:h-[426px] max-lg:py-8 py-4 px-8 flex flex-col gap-8 justify-between font-commissioner"}>
